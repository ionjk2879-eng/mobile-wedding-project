...
const AuthCallbackPage: React.FC = () => {
  ...
  if (error) {
    return (
      <div style={{ width: '100%', minHeight: '100dvh', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'Pretendard', sans-serif", gap: '16px' }}>
  ...
  return (
    <div style={{ width: '100%', minHeight: '100dvh', boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Pretendard', sans-serif", color: '#9CA3AF' }}>
      <p>로그인 처리 중...</p>
    </div>
  );
};
