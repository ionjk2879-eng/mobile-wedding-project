    ...
    <main className="legal-content">
      ...
      <table className="legal-table">
        ...
        <tbody>
          ...
          <tr><td>청첩장 제작</td><td>신랑·신부 이름, 연락처, 예식 일시·장소, 부모님 성함·연락처, 계좌 정보, 사진</td><td>청첩장 콘텐츠 구성 및 표시</td></tr>
          <tr><td>RSVP(참석 의사)</td><td>하객 이름, 참석 여부, 인원 수, 식사 여부, 메시지</td><td>참석 의사 수집 및 전달</td></tr>
      ...
      <ol>
        ...
        <li>RSVP·방명록 데이터: 해당 청첩장 삭제 시 함께 파기합니다.</li>
