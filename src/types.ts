...
export interface DesignConfig {
  theme?: 'blush' | 'champagne' | 'sage' | 'navy' | 'burgundy' | 'lavender' | 'dusty' | 'modern' | 'mocha' | 'cloud' | 'emerald' | 'butter' | 'cobalt' | 'terracotta' | 'rosegold' | 'midnight' | 'pearl' | 'mist' | 'walnut' | 'slate' | 'wisteria' | 'cedar' | 'stone' | 'copper' | 'sky' | 'linen' | 'olive' | 'noir' | 'peach';
