...
export const AI_PRESETS: AIPreset[] = [
  ...
  },
  {
    ...
    name: '테라코타 인스타 무드',
    category: '인스타',
    description: '따뜻한 어스톤 테라코타와 인스타그램 감성이 만난 감각적인 빈티지 무드',
    emoji: '🧡',
    previewColors: ['#FAF0E6', '#C4703A', '#4A2E1E'],
    tags: ['인스타카드 히어로', '어스톤 그라데이션 오프닝', '슬라이드 갤러리', 'Pretendard'],
    sampleSlug: 'junho-seoyeon',
    sampleHeroFromGallery: 3,
    accentOnText: true,
    settings: {
      theme: 'terracotta',
      fontFamily: "'Pretendard', sans-serif",
      ...
      galleryStyle: 'slide',
      accountStyle: 'style3',
      bgMusicUrl: '/music/nastelbom-romantic-436840.mp3',
      sectionOrder: ['photos', 'greeting', 'calendar', 'message', 'interview', 'timeline', 'location', 'accounts', 'contacts', 'share'],
      greetingTitle: '우리의 이야기를 공유합니다',
      greetingContent: '처음 만난 날부터 이 순간까지\n모든 기억이 사진처럼 빛나고 있습니다.\n\n따뜻하고 진실된 마음으로\n이 특별한 날에 여러분을 초대합니다.',
      groomMessage: '당신과 함께라면 매 순간이 피드에 남길 만한 장면이에요.',
      brideMessage: '우리의 이야기, 이제 함께 써 내려가요.',
      timeline: [
        { id: '1', date: '2021.04', showDate: true, year: '', title: '첫 연락', description: '용기를 내어 보낸 짧은 메시지 하나로 시작됐어요.', photo: '' },
        { id: '2', date: '2022.10', showDate: true, year: '', title: '첫 여행', description: '가을빛 물든 도시에서 함께 찍은 첫 번째 사진', photo: '' },
        { id: '3', date: '2024.11', showDate: true, year: '', title: '프로포즈', description: '노을이 지던 그 순간, 영원히 기억할 장면', photo: '' },
      ],
      interview: [
        { id: '1', question: '상대방의 첫인상은 어땠나요?', groomAnswer: '처음부터 뭔가 달랐어요. 자연스럽게 자꾸 눈이 갔어요.', brideAnswer: '따뜻한 눈빛이 제일 먼저 기억에 남았어요.' },
        { id: '2', question: '함께 찍은 사진 중 가장 좋아하는 건?', groomAnswer: '계획 없이 찍은 일상 속 셀카가 제일 좋아요.', brideAnswer: '웃음이 터진 순간들이요. 다 너무 좋아요.' },
        { id: '3', question: '앞으로 함께 하고 싶은 건?', groomAnswer: '매 계절마다 여행 가서 사진 잔뜩 찍고 싶어요.', brideAnswer: '평범한 일상도 당신과 함께라면 특별할 것 같아요.' },
      ],
      opening: {
        openingEnabled: true,
        openingStyle: 'insta',
        openingColorMode: 'gradient',
        openingGradientMode: 'custom',
        openingBgColor: '#B85A28',
        openingBgColor2: '#E09060',
        openingBgOpacity: 1,
        openingText: '우리 결혼합니다',
        openingSubText: '',
        openingFontStyle: 'clean',
